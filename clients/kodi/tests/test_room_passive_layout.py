...
def _assert_timed_autoscroll(case: unittest.TestCase, control: ET.Element) -> None:
    ...
    case.assertEqual(autoscroll.get("delay"), "3000")
    case.assertEqual(autoscroll.get("time"), "3000")
    case.assertEqual(autoscroll.get("repeat"), "3000")
...
class PassiveRoomLayoutTests(unittest.TestCase):
    ...
    def test_lobby_text_advances_without_focus_but_complete_url_stays_visible(self) -> None:
        ...
        self.assertEqual(join_urls.findtext("autoscroll"), "false")
        for control in textboxes:
