/**
 * Source-owned Golden Mischief tokens shared by generated native-client assets.
 * Browser CSS keeps its semantic custom properties; drift tests compare those values
 * with this package so native clients do not grow a second visual language.
 */
...
export const KODI_LAYOUT_TOKENS = {
    width: 1920,
    height: 1080,
    safeHorizontal: 96,
    safeVertical: 54,
    primaryTargetHeight: 76,
    panelRadius: 24,
    focusBorder: 6,
} as const;
