...
- Ambient music and interaction/reveal effects are original WAV assets bundled
  ...
  Question Category and DareType to its canonical visual family; the derived global
  Card intensity only tunes that family's warm gradient, SVG motif opacity, row count,
  and density. Background motifs are selected independently at random from the active
