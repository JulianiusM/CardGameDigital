...
These guides provide practical support for setup, safe play, accounts, Rooms, and
connection problems—not just a list of rules.

## Recommended order

1. **Quick start and setup** – choose a device topology and start a round.
2. **Game modes and cards** – understand the four session modes.
