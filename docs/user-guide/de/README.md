...
Hier findest du nicht nur Regeln, sondern konkrete Hilfe für die Vorbereitung, einen
sicheren Spielabend und typische Verbindungsprobleme.

## Empfohlene Reihenfolge

1. **Schnellstart und Spielaufbau** – passende Gerätekombination wählen und Runde
   starten.
2. **Spielmodi und Karten** – verstehen, wie die vier Modi ablaufen.
3. **Räume, Geräte und Spielleitung** – Raumcode, Party Screen, mehrere Personen pro
   Gerät und Hostwechsel.
